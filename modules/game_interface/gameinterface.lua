...
controlLeftCollumnsButton = nil
controlRightCollumnsButton = nil
controlRightCollumnsExtraButton = nil
logoutButton = nil
...
function init()
    ...
    controlLeftCollumnsButton = gameRootPanel:getChildById('gameSelectLeftColumn')
	controlRightCollumnsButton = gameRootPanel:getChildById('gameSelectRightColumn')
	controlRightCollumnsExtraButton = gameRootPanel:getChildById('gameSelectRightExtraColumn')
	
	controlLeftCollumnsButton.onClick = controlLeftCollumns
	controlRightCollumnsButton.onClick = controlRightCollumns
	controlRightCollumnsExtraButton.onClick = controlRightCollumns
...
function controlLeftCollumns()

if gameLeftPanel:isVisible() then
	modules.game_interface.getLeftPanel():setOn(false)
	controlLeftCollumnsButton:show()
	controlRightCollumnsButton:show()
	controlRightCollumnsExtraButton:show()
	controlLeftCollumnsButton:addAnchor(AnchorLeft, 'parent', AnchorLeft)
else 
	modules.game_interface.getLeftPanel():setOn(true)
	controlLeftCollumnsButton:show()
	controlRightCollumnsButton:show()
	controlRightCollumnsExtraButton:show()
	controlLeftCollumnsButton:addAnchor(AnchorLeft, 'gameLeftPanel', AnchorRight)
	end

end

function controlRightCollumns()

if gameRightExtraPanel:isVisible() then
	modules.game_interface.getRightExtraPanel():setOn(false)
	controlLeftCollumnsButton:show()
	controlRightCollumnsButton:show()
	controlRightCollumnsExtraButton:show()
	controlRightCollumnsButton:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
	controlRightCollumnsExtraButton:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
else 
	modules.game_interface.getRightExtraPanel():setOn(true)
	controlLeftCollumnsButton:show()
	controlRightCollumnsButton:show()
	controlRightCollumnsExtraButton:show()
	controlRightCollumnsButton:addAnchor(AnchorRight, 'gameRightExtraPanel', AnchorLeft)
	controlRightCollumnsExtraButton:addAnchor(AnchorRight, 'gameRightExtraPanel', AnchorLeft)
	end
